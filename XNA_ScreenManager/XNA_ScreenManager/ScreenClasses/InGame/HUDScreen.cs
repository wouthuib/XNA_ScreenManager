...
namespace XNA_ScreenManager.ScreenClasses
{
    ...
    public class HUDScreen : DrawableGameComponent
    {
        ...
        Texture2D Border, HP, SP, EXP, Skillbar, Chatbar, Chatbartop, Toolbar, Hightlight_Bars;
        Vector2 position = new Vector2(), skillbar_pos, chatbar_pos, toolbar_pos;
        #endregion
        ...
        protected override void LoadContent()
        {
            ...
            // new toolbar
            Toolbar = Content.Load<Texture2D>(@"gfx\hud\toolbar\toolbar");
            Hightlight_Bars = Content.Load<Texture2D>(@"gfx\hud\toolbar\highlight_bars");
        }
        #endregion
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (Active)
            {
                //DrawToolBarOld(gameTime);
                DrawToolBarGraph(gameTime);
                DrawToolBarInfo(gameTime);
                DrawSkillBar(gameTime);
                DrawChatBar(gameTime);
            }
        }

        private void DrawToolBarGraph(GameTime gameTime)
        {
            toolbar_pos = new Vector2(position.X, position.Y + gfxdevice.Viewport.Height - Toolbar.Height);

            //Toolbar menu
            spriteBatch.Draw(Toolbar, toolbar_pos, Color.White);

            //HP
            spriteBatch.Draw(HP, new Vector2(toolbar_pos.X + 220, toolbar_pos.Y + 22),
                new Rectangle(0, 0,
            ...
            //SP
            spriteBatch.Draw(SP, new Vector2(toolbar_pos.X + 329, toolbar_pos.Y + 22),
                new Rectangle(0, 0,
            ...
            //EXP
            spriteBatch.Draw(EXP, new Vector2(toolbar_pos.X + 441, toolbar_pos.Y + 22),
                new Rectangle(0, 0,
            ...
            // Bar hightlight
            spriteBatch.Draw(Hightlight_Bars, toolbar_pos, Color.White);
        }

        private void DrawToolBarInfo(GameTime gameTime)
        {
            string message;
            ...
            // LVL
            string Level = PlayerStore.Instance.activePlayer.Level.ToString("0 0");
            spriteBatch.DrawString(spriteFont, Level, new Vector2(toolbar_pos.X + 46, toolbar_pos.Y + 14), Color.White);

            // Name
            message = PlayerStore.Instance.activePlayer.Name + " - " + PlayerStore.Instance.activePlayer.Jobclass;
            spriteBatch.DrawString(spriteFont, message, new Vector2(toolbar_pos.X + 85, toolbar_pos.Y + 15), Color.White);
            ...
            spriteBatch.DrawString(smallFont, message.ToString(),
                new Vector2((toolbar_pos.X + 221 + Border.Width * 0.5f) - (smallFont.MeasureString(message).X * 0.5f), toolbar_pos.Y + 9),
                Color.White);

            // SP
            message = PlayerStore.Instance.activePlayer.SP + " / " + PlayerStore.Instance.activePlayer.MAXSP;
            spriteBatch.DrawString(smallFont, message.ToString(),
                new Vector2((toolbar_pos.X + 334 + Border.Width * 0.5f) - (smallFont.MeasureString(message).X * 0.5f), toolbar_pos.Y + 9),
                Color.White);
            ...
            spriteBatch.DrawString(smallFont, percentExp.ToString(),
                new Vector2((toolbar_pos.X + 450 + Border.Width * 0.5f) - (smallFont.MeasureString(percentExp).X * 0.5f), toolbar_pos.Y + 9),
                Color.White);
        }

        private void DrawToolBarOld(GameTime gameTime)
        {
        ...
        private void DrawSkillBar(GameTime gameTime)
        {
            skillbar_pos = new Vector2(
                position.X + (gfxdevice.Viewport.Width - Skillbar.Width) + 3,
                position.Y + (gfxdevice.Viewport.Height - Skillbar.Height - Toolbar.Height) + 3);
        ...
        private void DrawChatBar(GameTime gameTime)
        {
            chatbar_pos = new Vector2(position.X, position.Y + gfxdevice.Viewport.Height - Chatbar.Height - Toolbar.Height);
